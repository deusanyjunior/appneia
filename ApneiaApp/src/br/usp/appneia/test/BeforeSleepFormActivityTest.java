...
public class BeforeSleepFormActivityTest extends 
	...
	public void testBeforeSleepFormActivity_RadioNotPreChecked() {
		...
		assertFalse("mRadioBeforeSleepFormFirstQuestionYes should not be checked", 
				mRadioBeforeSleepFormFirstQuestionYes.isChecked());
		assertFalse("mRadioBeforeSleepFormFirstQuestionNo should not be checked", 
				mRadioBeforeSleepFormFirstQuestionNo.isChecked());
		assertEquals("mRadioGroupBeforeSleepFormFirstQuestion should not have checked radio",
				-1, mRadioGroupBeforeSleepFormFirstQuestion.getCheckedRadioButtonId());
		
		assertFalse("mRadioBeforeSleepFormSecondQuestionYes should not be checked", 
				mRadioBeforeSleepFormSecondQuestionYes.isChecked());
		assertFalse("mRadioBeforeSleepFormSecondQuestionNo should not be checked", 
				mRadioBeforeSleepFormSecondQuestionNo.isChecked());
		assertEquals("mRadioGroupBeforeSleepFormSecondQuestion should not have checked radio",
				-1, mRadioGroupBeforeSleepFormSecondQuestion.getCheckedRadioButtonId());
		
		assertFalse("mRadioBeforeSleepFormThirdQuestionYes should not be checked", 
				mRadioBeforeSleepFormThirdQuestionYes.isChecked());
		assertFalse("mRadioBeforeSleepFormThirdQuestionNo should not be checked", 
				mRadioBeforeSleepFormThirdQuestionNo.isChecked());
		assertEquals("mRadioGroupBeforeSleepFormThirdQuestion should not have checked radio",
				-1, mRadioGroupBeforeSleepFormThirdQuestion.getCheckedRadioButtonId());
	}
	...
	public void testBeforeSleepFormActivity_RadioChangeCheckedFirstQuestion() {
		...
		assertFalse("mRadioBeforeSleepFormFirstQuestionNo should not be checked",
				mRadioBeforeSleepFormFirstQuestionNo.isChecked());
		assertEquals("The first radio button from BeforeSleepFormFirstQuestion should be checked",
				R.id.radioBeforeSleepFormFirstQuestionYes, 
				mRadioGroupBeforeSleepFormFirstQuestion.getCheckedRadioButtonId());
		...
		assertFalse("mRadioBeforeSleepFormFirstQuestionYes should not be checked",
				mRadioBeforeSleepFormFirstQuestionYes.isChecked());
		assertEquals("The second radio button from BeforeSleepFormFirstQuestion should be checked",
	...
	public void testBeforeSleepFormActivity_RadioChangeCheckedSecondQuestion() {
		...
		assertFalse("mRadioBeforeSleepFormSecondQuestionNo should not be checked",
				mRadioBeforeSleepFormSecondQuestionNo.isChecked());
		assertEquals("The Second radio button from BeforeSleepFormSecondQuestion should be checked",
				R.id.radioBeforeSleepFormSecondQuestionYes, 
				mRadioGroupBeforeSleepFormSecondQuestion.getCheckedRadioButtonId());
	...
	public void testBeforeSleepFormActivity_RadioChangeCheckedThirdQuestion() {
		...
		assertFalse("mRadioBeforeSleepFormThirdQuestionNo should not be checked",
				mRadioBeforeSleepFormThirdQuestionNo.isChecked());
		assertEquals("The Third radio button from BeforeSleepFormThirdQuestion should be checked",
				R.id.radioBeforeSleepFormThirdQuestionYes, 
				mRadioGroupBeforeSleepFormThirdQuestion.getCheckedRadioButtonId());
		...
		assertFalse("mRadioBeforeSleepFormThirdQuestionYes should not be checked",
				mRadioBeforeSleepFormThirdQuestionYes.isChecked());
		assertEquals("The second radio button from BeforeSleepFormThirdQuestion should be checked",
	...
	public void testBeforeSleepFormActivity_ButtonStartMonitoring() {
		...
		MonitoringActivity mMonitorActivity = (MonitoringActivity)
		...
		assertEquals("Monitor for MonitoringActivity has not been called", 
